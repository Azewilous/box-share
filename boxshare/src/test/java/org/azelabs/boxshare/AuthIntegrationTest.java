...
class AuthIntegrationTest {
    ...
    void createFile_withoutToken_returns401() {
        FileRecord body = new FileRecord(null, "test.txt", null, null, "user@example.com", null, null, null, null);
    ...
    void createFile_withValidToken_returns200WithPresignedUrl() {
        ...
        FileRecord body = new FileRecord(null, "upload-" + UUID.randomUUID() + ".txt", null, null, "user@example.com", null, null, null, null);
    ...
    void getFile_withValidToken_forExistingFile_returns200() {
        ...
        FileRecord createBody = new FileRecord(null, filename, null, null, "user@example.com", null, null, null, null);
